var BattleController = (function () {
    ...
    BattleController.prototype.newBattle = function (player1, player2) {
        ...
        var team1 = new Team(player1.getSocket(), player1.getBaseTeam(), tiebreaker);
        var team2 = new Team(player2.getSocket(), player2.getBaseTeam(), !tiebreaker);
...
var Battle = (function () {
    ...
    Battle.prototype.switchSubmitted = function () {
...
var Team = (function () {
    function Team(socket, baseTeam, tiebreaker) {
        this._socket = socket;
        var units = new Array();
